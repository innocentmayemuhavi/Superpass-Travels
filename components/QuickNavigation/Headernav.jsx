...
const HeaderNav = () => {
  ...
  return (
    <section className="desktop-nav">
      <Link to={"/"}>
        <Button text="Home" onClick={()=>settabnumber(1)} style={{
          transition:'0.8s',
      ...
      <Link to="/carbooking">
        <Button text="Booking" onClick={()=>settabnumber(2)} style={{
          transition:'0.8s',
      ...
      <Link to={'/about'}>
        <Button text="About" onClick={()=>settabnumber(4)} style={{
          transition:'0.8s',
      ...
      <Link to={'/contact'}>
        <Button text="Contact" onClick={()=>settabnumber(5)} style={{
          transition:'0.8s',
